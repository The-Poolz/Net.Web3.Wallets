...
namespace Net.Web3.EthereumWallet.Tests.Extensions;

public class AddressExtensionsTests
{
    public class ConvertToChecksumAddress
    {
        [Theory]
    ...
    public class IsChecksumAddress
    {
        [Theory]
        ...
        [InlineData("0x5aaeb6053F3E94C9B9A09f33669435E7Ef1BeAed", 1234, false)]
        [InlineData("0xfb6916095ca1df60bb79Ce92ce3ea74c37c5d359", 1234, false)]
        [InlineData("0xDBF03B407C01E7CD3CBEA99509D93f8DDDC8C6FB", 1234, false)]
        [InlineData("0xD1220A0cf47c7B9Be7A2E6BA89F429762e7b9aDb", 1234, false)]
